...
// every result to the cart in one shot and streams availabilities back as
// NDJSON lines while ContiLink resolves them. Much faster than one
// /api/conti/availability round-trip (cold Chromium + login) per row.
